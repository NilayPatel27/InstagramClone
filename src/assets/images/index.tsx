...
const SearchPage = require("./SearchPage.png");

export { Back, Remove, Edit, Image, Plus, WhitePlus, Delete, Hide, HideAll, Report, User, InstagramLogo, SplashScreen, NoPostsImage, SearchPage };