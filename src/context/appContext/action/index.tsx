...
import { feedUploadRequest } from "@instagram/context/appContext/action/auth/index.tsx";
...
import { followUser } from "@instagram/context/appContext/action/auth/index.tsx";
import { unFollowUser } from "@instagram/context/appContext/action/auth/index.tsx";

export { loginRequest, setLoader, logOutRequest, userNameExistRequest, userEmailExistRequest, signUpRequest, feedUploadRequest, feedListRequest, deleteUserAccountRequest, deleteUserFeedRequest, allUsersRequest, getUserDetails, updateUserDetails, followUser, unFollowUser };