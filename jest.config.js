module.exports = {
  ...
  transformIgnorePatterns: [
    "node_modules/(?!(react-native|@react-native|@react-navigation|react-native-vector-icons|@rneui|react-native-ratings|react-native-size-matters|react-native-fs|react-native-image-crop-picker)/)"
  ],
